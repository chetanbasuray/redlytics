...
const Loader: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 bg-gray-800/50 rounded-lg border border-gray-700">
      ...
      <h3 className="text-xl font-semibold text-white mb-2">Fetching &amp; Analyzing...</h3>
      <p className="text-gray-400">Grabbing up to 1000 posts and 1000 comments from Reddit. This might take a moment.</p>
    </div>
  );
};
